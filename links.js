// ============ 对外链接集中配置 ============
// 上架前请把这 4 个占位链接替换为你自己的真实地址（全部免费注册）：
// 1. donate         爱发电资助页（https://afdian.net 注册后进入"我的主页"复制链接）
// 2. github         GitHub 仓库主页（创建仓库后复制）
// 3. issues         GitHub 问题反馈页（仓库 Issues → New issue 的链接）
